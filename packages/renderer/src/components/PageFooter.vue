<template>
  <footer class="bg-white border-t border-gray-200 shadow sm:flex sm:items-center sm:justify-between p-4 sm:p-6 xl:p-8 dark:bg-gray-800 dark:border-gray-700 antialiased">
